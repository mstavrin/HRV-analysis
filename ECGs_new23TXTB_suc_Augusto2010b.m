...
%% 21 Jan 2010,  14 martiou 2010 BURGS method
...
for q=1:a7
    ...
    clear current_name
        ...
        interpol_intervaloRR=csapi(tbefore, intervaloRR,xi);
        figure; plot(tbefore, intervaloRR, 'o', xi, interpol_intervaloRR, '+'); 
